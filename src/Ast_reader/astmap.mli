...
and as_pos = RHS | LHS_leftmost

val d_ctxt: expr_context
...
class ['a] tree_mapper: 'a user_fun ->
  object
    ...
    method app: expr_context -> (expr * nexpr list, 'a) mapper
    ...
    method core_expr: pos -> expr_context -> (core_expr, 'a) mapper
    ...
    method expr: expr_context -> (expr, 'a) mapper
    method expr_id: expr_context -> (loc_ident, 'a) mapper
    ...
    method nexpr: expr_context -> (nexpr, 'a) mapper
    ...
    method select: expr_context -> (expr * loc_ident, 'a) mapper
...
class ['b] short_mapper: 'a tree_mapper -> ('a -> 'b) -> ('b -> 'a) ->
  object
    ...
    (* to be completed... 
     * Will be equivalent to  'b tree_mapper when I have added all methods. *)
  end
